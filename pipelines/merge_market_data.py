...
HEADLINES_PATH = PROJECT_ROOT / 'data' / 'processed' / 'headlines_with_sentiment.parquet'
...
OUTPUT_PATH = PROJECT_ROOT / 'data' / 'processed' / 'merged_features.parquet'


def main():
    """Aggregate daily sentiment and merge with prices and (optional) tension scores."""
    df_news = pd.read_parquet(HEADLINES_PATH)
